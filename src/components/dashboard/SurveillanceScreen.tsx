...
export default function SurveillanceScreen({ camera, zoomLevel, onClick, darkMode = true, isPlaying = true }: any) {
    ...
    return (
        ...
        >
            ...
            <div className={`w-full h-full flex items-center justify-center relative ${darkMode ? 'bg-[#050505]' : 'bg-slate-100'}`}>
                ...
                {/* Active Object Indicators (Overlay on top of video) */}
                {camera.hasActivity && (
                    <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex gap-2 z-10 bg-black/50 px-2 py-1 rounded-full backdrop-blur-sm">
            ...
            {/* Hover Assessment Overlay - Only functional for desktop/mouse users really */}
